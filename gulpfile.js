...
var requireJsRuntimeConfig = vm.runInNewContext(fs.readFileSync('src/app/require.config.js') + '; require;');
    requireJsOptimizerConfig = merge(requireJsRuntimeConfig, {
        ...
        include: [
            ...
            //'components/api-test/apitest',
            'components/accession-page/accession',
            'components/marker-page/marker',
            'components/variant-page/variant',
            'components/23andMe-OAuth/login',
